  ...
  inline void get_sdcard_commands() {
    ...
    while (commands_in_queue < BUFSIZE && !card_eof && !stop_buffering) {
      ...
      if (card_eof || n == -1
        ...
        if (sd_char == 'G')
        {
        	tftPowerLossCardCurrent = card.getIndex();
        }
        #endif
      }
    }
...
inline void gcode_G28(const bool always_home_all) {
  ...
  endstops.not_homing();
    ...
    if (leveling_was_active)
    {
    	SERIAL_ECHOLNPGM("Leveling is active");
    }
  #endif
...
#if ENABLED(ANYCUBIC_CHIRON)
  if((!isAutoLeveling()) && (!card.sdprinting) && (homeZ||home_all))
  {
...
#ifdef ANYCUBIC_CHIRON
      case 1000: gcode_M1000();break;								  // M1000: AC ManualLeveling Mode
      case 1001: gcode_M1001();break;								  // M1001: AC AutoLeveling Mode
      case 1005: gcode_M1005();break;								  // M1005: AC Power loss management, (G5 command)
#endif
      default: parser.unknown_command_error();
    }
    break;
