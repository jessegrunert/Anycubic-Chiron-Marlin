...
//#define TFT_ENABLE_DEBUG
#ifdef TFT_ENABLE_DEBUG
#include "serial.h"
static unsigned char IO_DIRECTION = 0;
void serialLoger(char c, unsigned char direction)
{
  if (IO_DIRECTION != direction)
  {
    if (c >= 0x20)
    {
      if (direction == 1)
